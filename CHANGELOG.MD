...
- native `.loading` class renamed using the `$bdk-prefix` -> `.bdk-loading` allowing the designer to use the initial class
...
>>>>>>> 75cc5dc89847285aabfa6c3764bf2a74c2866f55
...
>>>>>>> 2dd3bfc93aed3b539db92adc2b68d68f0f3a8274
